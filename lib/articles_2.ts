// lib/articles_2.ts — extracted inline articles
...
const articles: Article[] = [
  ...
  toc: [
    { heading: "Best Intelligence Build Level 150", anchor: "best-intelligence-build-level-150" },
    { heading: "Intelligence Damage Testing", anchor: "intelligence-damage-testing" },
    { heading: "Comparison With Other Mage Setups", anchor: "comparison-with-other-mage-setups" },
    { heading: "60 INT vs 80 INT", anchor: "60-int-vs-80-int--which-should-you-choose" },
    { heading: "Pure Mage vs Moonveil Battlemage", anchor: "two-intelligence-build-paths--pure-mage-vs-moonveil-battlemage" },
    { heading: "Best Weapons", anchor: "best-weapons-for-intelligence-build--complete-guide" },
    { heading: "Best Sorceries by Situation", anchor: "best-sorceries-by-situation" },
    { heading: "Shadow of the Erdtree DLC Setup", anchor: "best-intelligence-build-for-shadow-of-the-erdtree-dlc" },
    { heading: "Boss Matchup Guide", anchor: "intelligence-build-against-bosses" },
    { heading: "Best Starting Classes", anchor: "best-starting-classes-for-intelligence-build" },
    { heading: "Best Stats", anchor: "best-intelligence-build-stats" },
    { heading: "Best Talismans", anchor: "best-talismans-for-intelligence-build" },
    { heading: "Best Armor", anchor: "best-armor-for-intelligence-build" },
    { heading: "Leveling Progression", anchor: "leveling-progression" },
    { heading: "Best Flask Setup", anchor: "best-flask-setup" },
    { heading: "Strengths and Weaknesses", anchor: "strengths-and-weaknesses" },
    { heading: "FAQ", anchor: "frequently-asked-questions" },
  ],

  title: "Best Intelligence Build Elden Ring (2026) – Max Damage Mage Setup",

  metaDescription:

    "Level 150 Intelligence build guide for Elden Ring and Shadow of the Erdtree. Max damage mage stats, weapons, sorceries, talismans, and boss matchups.",
  ...
  sections: [

    {
      ...
      content: "The Intelligence build in Elden Ring is one of the strongest and most versatile playstyles. It lets players deal massive magic damage, control fights from range, and burst down bosses with powerful sorceries.\n\nThis guide covers the **best Intelligence build in Elden Ring**, including optimal stats, weapons, spells, talismans, and progression path.",

    },

    // ═══ New: Lv 150 quick-recommendation (SEO intent front-loaded) ═══

    {

      heading: "Best Intelligence Build Level 150",

      level: 2,

      content: "Most PvE players stop around Level 150. Here is the recommended Intelligence build for that level: a balanced mage with enough HP for late-game bosses and Shadow of the Erdtree content.",

      table: {

        headers: ["Attribute", "Value", "Notes"],

        rows: [

          ["Vigor", "60", "Survivability is king; non-negotiable"],

          ["Mind", "25", "Covers most boss fights"],

          ["Endurance", "25", "Medium roll with balanced armor"],

          ["Strength", "12", "Minimal"],

          ["Dexterity", "18", "Weapon requirements only"],

          ["Intelligence", "70", "93% of max sorcery scaling"],
...

    {
      ...
      heading: "Recommended Lv 150 Weapons",

      level: 3,

      content: "These three weapons cover most playstyles within an Intelligence build:",

      table: {

        headers: ["Weapon", "Best For", "Upgrade Path"],

        rows: [

          ["Carian Regal Scepter +10", "All-around sorcery", "Somber Smithing Stone 9"],

          ["Moonveil +10", "Hybrid melee + ranged", "Smithing Stone 9"],

          ["Dark Moon Greatsword +10", "Melee + sorcery hybrid", "Smithing Stone 9"]
...

    {
      ...
      heading: "Lv 150 Playstyle",

      level: 3,

      content: "A balanced Intelligence mage at Lv 150 plays for longevity. You can hold your own against most bosses with good positioning, and you have enough HP to survive the aggressive attacks in Shadow of the Erdtree. If you want more damage, shift from INT 70 to INT 80 — but you will need to accept lower Vigor (50–55)."
...

    {
      ...
      heading: "Intelligence Damage Testing",

      level: 2,

      content: 'We measured maximum magic damage output under identical conditions using our [Build Planner](https://www.zosygo.com/elden-ring/tools/build-calculator).',
      ...
      table: {
        ...
        rows: [
          ...
          ["Spell", "Comet Azur (full charge, channel complete)"],

          ["Talismans", "Graven-Mass + Magic Scorpion Charm + Radagon Icon"],

          ["Physick", "Magic-Shrouding Cracked Tear + Intelligence-Knot Crystal Tear"],

          ["Target", "Malenia (Phase 1, no buffs, base defense)"],

          ["NG+ Status", "NG0"],

          ["Caster Buffs", "None (Terra Magicus excluded)"],

          ["Scadutree Blessing", "None (base stats only)"],

          ["Comet Azur Total Damage", "~15,000–18,000 HP (one full channel)"],
...

    {
      ...
      heading: "Intelligence Build Against Bosses",

      level: 2,

      content: "Different bosses demand different Intelligence setups. Here is a quick matchup table so you know which setup to pull out before each fight:",

      table: {

        headers: ["Boss", "Recommended Setup", "Key Spells"],

        rows: [

          ["Malenia", "Night Comet + Moonveil", "Night Comet (unseen), Transient Moonlight skill"],

          ["Radagon", "Magic damage + Dark Moon", "Comet Azur burst, Great Glintstone Shard DPS"],

          ["Elden Beast", "Physical backup weapon", "Wing of Astel, Moonveil as melee fallback"],

          ["Messmer", "Rock Sling stagger", "Rock Sling, Stars of Ruin for close-range groups"],

          ["Mohg (Lord of Blood)", "Night Comet + Magic Shield", "Night Comet, Magic Scorpion Charm"],

          ["Loretta (DLC)", "Fast cast + counter", "Carian Slicer, Swift Glintstone Shard"],

          ["Messmer's Soldier", "Stagger spam", "Rock Sling, Stars of Ruin"],

          ["Messmer, Prince of Death", "Full burst", "Comet Azur, Magic-Shrouding Tear physick"]
...

    {
      ...
      heading: "Best Intelligence Build Stats",

      level: 2,

      content: "See the [Best Intelligence Build Level 150](#best-intelligence-build-level-150) section above for the full recommended stat breakdown. A few notes on how the primary stats shape your build:",
      ...
      table: {
        ...
        rows: [
          ...
          ["Vigor", "55–60", "Survival priority; non-negotiable for late game"],

          ["Intelligence", "60–80", "60 = 85% scaling (Lv 150), 80 = max scaling (Lv 200+)"],

          ["Mind", "25–30", "Sustained spellcasting"],

          ["Endurance", "20–25", "Medium roll + equip load"],

          ["Strength", "10–12", "Minimal"],

          ["Dexterity", "18–25", "Moonveil requires 23 DEX"],
...

    {
      ...
      heading: "How much intelligence do I need in Elden Ring?",

      level: 3,

      content: "For most players, INT 60 at Level 150 is the sweet spot — you get 85% of maximum sorcery scaling and still have room for Vigor 60. For pure mage builds at Level 200+, go INT 80 for maximum damage."
...

    {
      ...
      content: "Only if you are building a Level 200+ pure mage focused on boss burst damage. Below Level 200, the points spent getting from 70 to 80 INT are better spent on Vigor or Endurance."

    },

    {

      heading: "What is the strongest Intelligence weapon?",

      level: 3,

      content: "For pure sorcery, Lusat's Glintstone Staff gives the highest spell damage. For melee hybrids, Moonveil and Dark Moon Greatsword are the strongest options. See our [Best Moonveil Build](/elden-ring/builds/best-moonveil-build) and [Dark Moon Greatsword Build](/elden-ring/builds/best-dark-moon-greatsword-build) guides for details."

    },

    {

      heading: "Does Intelligence work in Shadow of the Erdtree?",

      level: 3,

      content: "Yes. Intelligence remains strong in the DLC. Night Comet works especially well because many DLC bosses close distance aggressively. Use Rock Sling for stagger and Carian Slicer for counter-attacks. The recommended setup is INT 70, Vigor 60, Dark Moon Greatsword + Carian Regal Scepter. See the [DLC section](#best-intelligence-build-for-shadow-of-the-erdtree-dlc) above."
...

    {
      ...
      content: "Yes. Moonveil is one of the best hybrid Intelligence weapons. See our complete [Moonveil Build Guide](/elden-ring/builds/best-moonveil-build) for stats, talismans, and playstyle."
  ...
  internalLinks: [
    ...
    { href: "/elden-ring/tools/build-calculator", anchorText: "Build Planner" },
